...
//
// File: confo.js
// This is the main conference application file for client end point. It tries to use Airtel IQ Web Toolkit to
// communicate with Airtel IQ Servers
//
...
var username = null;
var room;
var SUPPORT_URL = "https://api.videoiq.airtel.in/";
// Player Options
var options = {
    id: 'vcx_1001',
    attachMode: '',
    ...
    toolbar: {
        ...
        'branding': {
            'display': false,
            'clickthru': 'https://api.videoiq.airtel.in/',
            'target': 'new',
            'logo': 'img/airtel-logo.png',
            'title': 'Airtel IQ',
            'position': 'right'
        }
    }
